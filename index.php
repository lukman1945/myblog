...
<html lang="en">
  <head>
    ...
    <title>I, Portfolio - Personal Category Bootstrap Responsive Website Template | Home : W3layouts</title>
        ...
        <div class="banner-wrapper text-center">
            ...
            <ul class="follow-social">
                ...
                <?php 
		              include 'koneksi.php';
		              $no = 1;
		              $data = mysqli_query($koneksi,"select * from sosmed");
		              while($d = mysqli_fetch_array($data)){
			          ?>
                <li><a href="<?php echo $d['link'] ?>"><span class="<?php echo $d['icon'] ?>"></span></a></li>
                <?php } ?>
            </ul>
        </div>
    </div>
            ...
            <div class="row">
                <div class="col-lg-6">
                    ...
                    <?php 
		                  ...
		                  while($d = mysqli_fetch_array($data)){
			              ?>
                        <li class="service-link"><a href=""><?php echo $d['judul_service']; ?></a></li>
                    <?php } ?>
                    </ul>
                ...
                <div class="col-lg-6 mt-lg-0 mt-md-5 mt-4">
                    ...
                    <p class="mt-4">I Specialize in Branding and Strategy, and am passionate about creating Awesome
                        ...
                        <?php 
		                      include 'koneksi.php';
		                      $no = 1;
		                      $data = mysqli_query($koneksi,"select * from skill");
		                      while($d = mysqli_fetch_array($data)){
			                  ?>
                    <div class="skills-bars mt-5">
                        <div class="progress-info">
                            <h6 class="progress-tittle"><?php echo $d['judul']?></h6>
                            <div class="progress">
                                <div class="progress-bar progress-bar-striped" role="progressbar" style="width: <?php echo $d['persentase'] ?>%" aria-valuenow="<?php echo $d['persentase'] ?>" aria-valuemin="0" aria-valuemax="100">
                                </div>
                            </div>
                        </div>
                    </div>
        ...
        <div class="container py-lg-4 py-md-3">
            ...
            <div class="row mt-md-5 mt-4 pt-lg-3">
                ...
                <?php 
                  ...
                  $simpan = mysqli_query($koneksi,"insert into contact_customer values('','$nama','$email','$subject','$isi_pesan',)");
                  ...
                  if($simpan){
                    ...
                    <form action="" method="post">
                        <div class="twice-two">
                            <input type="text" class="form-control" name="nama" id="w3lName" placeholder="Name"
                                required="">
                        ...
                        <textarea name="isi_pesan" class="form-control" id="w3lMessage" placeholder="Message"
                            required=""></textarea>
